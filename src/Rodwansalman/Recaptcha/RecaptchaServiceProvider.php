<?php namespace Rodwansalman\Recaptcha;
 ...
 * 
 * @author     Greg Gilbert
 * @link       https://github.com/rodwansalman
...
class RecaptchaServiceProvider extends ServiceProvider
{
	...
	{
		$this->package('rodwansalman/recaptcha');
	...
	public function addValidator()
	{
		...
		{
			$captcha = app('rodwansalman\Recaptcha\RecaptchaInterface');
	...
	public function addFormMacro()
	{
		app('form')->macro('captcha', function($options = array())
		{
            ...
            $view = 'recaptcha::' . app('rodwansalman\Recaptcha\RecaptchaInterface')->getTemplate();
	...
	{
        $this->app->bind('rodwansalman\Recaptcha\RecaptchaInterface', function()
        {
